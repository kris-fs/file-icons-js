...
["icon-file-text",["dark-red","dark-red"],/\.git[\/\\]description$|(\\|\/)share(?:\1misc)?\1(?:operator|mail\.(?:tilde)?help)$/],
...
["icon-file-text",["dark-blue","dark-blue"],/\.(?:i?nfo|lcov)$/i,,/^lcov$/,/\.lcov$/i,/^Text$|^lc[0o]v$/i],
